...
public class SecondOrderButtonTest {
    ...
    //Конструктор
    public SecondOrderButtonTest(String name, String surname, String address, String phoneNumber, String deliveryDate) {
        this.name = name;
    ...
    public void testSecondButtonTest() {
        mainPageSamokat.clickOrderDownButton(); //Клик на верхнюю кнопку "Заказать" на главной странице
